...
public enum ErrorCodes {
  ...
  /**
   * This code specifies that it does not match with any conversation line type specified in
   * paragraph conversationType enum
   */
  INVALID,
  ...
  /**
   * This code specifies that a line has been identified as different type instead of its actual
   * type
   */
  INCORRECT_LINE_TYPE,
